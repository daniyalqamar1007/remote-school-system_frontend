...
import { CheckIcon, Loader2, Eye, EyeOff, RefreshCw } from "lucide-react"
...
export default function AddTeacherModal({ isOpen, onClose, teacherData, onSuccess }: AddTeacherModalProps) {
  ...
  const generateEmployeeId = () => {
    ...
    const generatedId = `EMP${firstInitial}${lastInitial}${timestamp}${randomNum}`;
