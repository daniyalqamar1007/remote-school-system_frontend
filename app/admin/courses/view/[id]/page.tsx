...
export default function CourseDetailPage() {
  ...
  const fetchCourse = async () => {
    try {
      ...
      const res = await axios.get(`${process.env.NEXT_PUBLIC_SRS_SERVER}/admin/courses/${id}`, { headers: { Authorization: `Bearer ${token}` } })
    ...
    <div className="space-y-6 p-4 sm:p-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          <Button variant="outline" onClick={() => router.push('/admin/courses')}><ArrowLeft className="h-4 w-4 mr-2" />Back</Button>
