      ...
      if (!skipParentValidation && parentIsNew) {
        ...
        try {
          ...
          try {
            ...
            console.log('📤 [Frontend] Sending parent creation request with data:', {
              email: parentPayload.email,
              firstName: parentPayload.firstName,
              lastName: parentPayload.lastName,
              isPrimaryContact: parentPayload.isPrimaryContact,
              hasPickupPermission: parentPayload.hasPickupPermission,
            ...
            console.log('👪 [Frontend] Parent created successfully:', createParentRes.data)
            console.log('👪 [Frontend] Parent document data:', {
              _id: createParentRes.data?.data?._id,
              isPrimaryContact: createParentRes.data?.data?.isPrimaryContact,
              hasPickupPermission: createParentRes.data?.data?.hasPickupPermission,
            })
