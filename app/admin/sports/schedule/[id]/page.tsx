  ...
  const fetchScheduleDetails = async () => {
    try {
      ...
      if (!scheduleData) {
        ...
        router.push('/admin/sports/schedule');
        return;
      }
  ...
  return (
    <div className="container mx-auto px-4 py-6 space-y-6">
      ...
      <div className="flex items-center gap-4">
        <Link href="/admin/sports/schedule">
      ...
      <div className="flex gap-2">
        <Link href={`/admin/sports/schedule/${scheduleId}/edit`}>
          <Button variant="outline">
            Edit Event
          </Button>
        </Link>
        <Link href={`/admin/sports/attendance?schedule=${scheduleId}`}>
          <Button>
