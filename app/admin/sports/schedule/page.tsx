  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <Link href="/admin/sports/schedule/new">
                      ...
                      >
                        ...
                        <TableCell className="text-right">
                          <div className="flex justify-end gap-1">
                            <Link href={`/admin/sports/schedule/${schedule._id}`}>
                              <Button variant="ghost" size="sm" title="View">
                                <Eye className="h-4 w-4 text-black" />
                              </Button>
                            </Link>
                            {/* <Link href={`/admin/sports/attendance?schedule=${schedule._id}`}>
                              <Button variant="ghost" size="sm" title="Attendance">
                                <Users className="h-4 w-4 text-black" />
                              </Button>
                            </Link> */}
                            <Link href={`/admin/sports/schedule/${schedule._id}/edit`}>
