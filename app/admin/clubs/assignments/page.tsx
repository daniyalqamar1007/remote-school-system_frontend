...
export default function ClubAssignmentsPage() {
  ...
  const filteredMemberships = memberships.filter((m: any) => {
    // Skip if studentId is null/undefined
                    ...
                    {paginatedMemberships.map((membership: any) => (
                      <TableRow key={membership._id}>
                        <TableCell className="font-medium">
                          {membership.studentId?.firstName || 'N/A'} {membership.studentId?.lastName || ''}
                        </TableCell>
                        ...
                        <TableCell>
                          {membership.joinedDate ? new Date(membership.joinedDate).toLocaleDateString() : 'N/A'}
                        </TableCell>
                        <TableCell>
                          <Button
                            size="sm"
                  ...
                  <TableBody>
                    {paginatedRequests.map((request: any) => (
                      <TableRow key={request._id}>
                        <TableCell className="font-medium">
                          {request.studentId?.firstName || 'N/A'} {request.studentId?.lastName || ''}
                        </TableCell>
