...
export default function PasswordManagement() {
  ...
  const fetchUsers = async () => {
    try {
      ...
      const url = `${process.env.NEXT_PUBLIC_SRS_SERVER}/admin/users?${params.toString()}`
  ...
  const handleUpdatePassword = async () => {
    ...
    try {
      ...
      const response = await fetch(`${process.env.NEXT_PUBLIC_SRS_SERVER}/admin/users/${selectedUser._id}/reset-password`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
