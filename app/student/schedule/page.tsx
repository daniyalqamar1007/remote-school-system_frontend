...
export default function StudentSchedulePage() {
  ...
  const fetchSchedule = async () => {
    try {
      ...
      const studentId = localStorage.getItem("id") || localStorage.getItem("studentId") || localStorage.getItem("userId")
      ...
      try {
        ...
        setStudentInfo({
          class: studentData?.class || studentData?.gradeLevel || 'N/A',
      ...
      try {
        ...
        try {
          ...
          const studentGrade = studentInfo?.class || ''
      ...
      if (err.response?.status === 404) {
        ...
        setError("An error occurred while loading your schedule. Please try again later.")
      }
    } finally {
      setLoading(false)
    }
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center justify-center min-h-[400px]">
            <div className="text-center">
              ...
              <p className="text-lg font-medium text-gray-600 dark:text-gray-400">Loading your schedule...</p>
