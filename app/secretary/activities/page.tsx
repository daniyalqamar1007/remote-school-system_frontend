...
export default function ActivitiesPage() {
  ...
  const fetchActivities = async (page: number = 1, limit: number = 10) => {
    try {
      ...
      const secretaryId = userInfo._id || userInfo.id
      ...
      <div className="mx-auto max-w-7xl space-y-8">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-500">Track and monitor all Secretary activities.</p>
          </div>
        </div>
                    ...
                    activities.map((activity) => (
                      <TableRow key={activity._id}>
                        ...
                        <TableCell className="hidden lg:table-cell">
                          <div className="text-sm">{activity.performBy || 'Secretary'}</div>
                        </TableCell>
