                    ...
                    <TableRow key={assignment._id}>
                      ...
                      <TableCell className="text-right">
                        <div className="flex justify-end gap-1">
                          ...
                          <Link href={`/secretary/sports/assignments/${assignment._id}`}>
                            <Button
                              variant="ghost"
                              size="sm"
                              title="View details"
          ...
          {selectedStudent && (
            <div className="border-t pt-4">
              ...
              {loadingHealth ? (
                ...
                <div className="text-center py-4">
                  <p className="text-sm text-gray-600">Health status information will appear here once a student is selected.</p>
                </div>
              )}
