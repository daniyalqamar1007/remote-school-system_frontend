  ...
  const handleExcelUpload = (schoolId: string) => {
    ...
    input.onchange = async (e) => {
      ...
      try {
        ...
        const response = await axios.post(`${process.env.NEXT_PUBLIC_SRS_SERVER}/admin/teachers/import`, formData, {
            ...
            <Table>
              <TableHeader>
                <TableRow>
                  ...
                  <TableHead className="min-w-[150px] hidden md:table-cell">School</TableHead>
                      ...
                      <TableCell>
                        <div className="flex gap-1">
                          <Button
                            variant="ghost"
                            size="sm"
                            onClick={() => router.push(`/super-admin/teachers/view/${teacher._id}?schoolId=${teacher.schoolId?._id || ''}`)}
                            title="View"
                          >
      ...
      <Dialog open={isImportModalOpen} onOpenChange={setIsImportModalOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Select the school to import teachers for, then choose a CSV/XLS/XLSX file.
            </DialogDescription>
          </DialogHeader>
