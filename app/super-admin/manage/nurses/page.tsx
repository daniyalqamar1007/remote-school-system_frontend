...
//         },
//       })
//       const list = data?.data?.schools || data?.data || []
...
//   const extractSchoolId = useCallback((nurse: Nurse | null) => {
//     if (!nurse || !nurse.schoolId) return ""
//     if (typeof nurse.schoolId === "string") return nurse.schoolId
//     return nurse.schoolId?._id || ""
//   }, [])

//   const schoolOptions = useMemo(() => {
//     return schools.map((school) => [
//       school._id,
//       school.name || school.schoolCode || "Unnamed School",
//     ])
//   }, [schools])

//   const getSchoolDisplayName = useCallback(
//     (nurse: Nurse) => {
//       if (typeof nurse.schoolId === "object" && nurse.schoolId?.name) {
//         return nurse.schoolId.name
//       }
//       if (nurse.schoolName) return nurse.schoolName
//       if (typeof nurse.schoolId === "string") {
//         const school = schools.find((s) => s._id === nurse.schoolId)
//         if (school) {
//           return school.name || school.schoolCode || "Unnamed School"
//         }
//       }
//       return "N/A"
//     },
...
//     const schoolFromList = schools.find((school) => school._id === form.schoolId)
//     if (schoolFromList) return schoolFromList.name || schoolFromList.schoolCode || "Unnamed School"

//     if (isEditing) {
//       const activeNurse = nurses.find((nurse) => nurse._id === activeNurseId)
//       if (activeNurse) {
//         if (typeof activeNurse.schoolId === "object" && activeNurse.schoolId?._id === form.schoolId) {
//           return activeNurse.schoolId.name || activeNurse.schoolName || "Unnamed School"
//         }
//         if (activeNurse.schoolName) return activeNurse.schoolName
//       }
//     }

//     return ""
//   }, [form.schoolId, schools, isEditing, nurses, activeNurseId])
...
//       ...initialNurseForm,
//       schoolId:
//         typeof nurseData.schoolId === "string"
//           ? nurseData.schoolId
//           : nurseData.schoolId?._id || "",
...
//   const fetchNurseDetails = async (nurseId: string, schoolId: string) => {
//     try {
//       if (!schoolId) {
//         throw new Error("School information is required to load nurse details.")
//       }
...
//       // Properly type error to handle unknown type
//       let errorMessage = "Failed to load nurse details. Please try again.";
...
//       payload.append("schoolId", form.schoolId)
...
//       if (isEditing && activeNurseId) {
//         const response = await axios.put(`${API}/admin/nurses/${activeNurseId}`, payload, { headers })
//         if (response.status === 200) {
//           toast.success(response.data?.message || "Nurse updated successfully")
//         } else {
//           toast.error(response.data?.message || "Failed to update nurse")
//         }
//       } else {
//         const response = await axios.post(`${API}/admin/nurses`, payload, { headers })
//         if (response.status === 200) {
//           toast.success(response.data?.message || "Nurse saved successfully")
//         } else {
//           toast.error(response.data?.message || "Failed to save nurse")
//         }
//       }
...
//     const schoolId = extractSchoolId(nurseToDelete)
//     if (!schoolId) {
//       toast.error("Unable to delete nurse because school information is missing.")
//       return
//     }
...
//       toast.success(response.data?.message || "Nurse deleted successfully! 🗑️", {
//         duration: 3000,
//       })
...
//     const schoolId = extractSchoolId(nurse)
//     if (!schoolId) {
//       toast.error("Unable to open nurse details because school information is missing.")
//       return
//     }
//     router.push(`/super-admin/manage/nurse/view/${nurse._id}?schoolId=${encodeURIComponent(schoolId)}`)
//   }

//   const handleEditNurse = (nurse: Nurse) => {
//     const schoolId = extractSchoolId(nurse)
//     if (!schoolId) {
//       toast.error("Unable to edit nurse because school information is missing.")
//       return
//     }
//     setIsEditing(true)
...
//     setIsPhoneValid(true)
//     setOpen(true)
//     fetchNurseDetails(nurse._id, schoolId)
//   }
...
//         <TableCell className="hidden lg:table-cell">{getSchoolDisplayName(nurse)}</TableCell>
...
//                 disabled={isSchoolsLoading && !schools.length}
//               >
//                 <SelectTrigger>
//                   <SelectValue placeholder={isSchoolsLoading ? "Loading schools..." : "Filter by school"} />
//                 </SelectTrigger>
//                 <SelectContent>
...
//                     <TableHead className="hidden lg:table-cell">School Name</TableHead>
...
//                         </Label>
//                         {isEditing ? (
//                           <Input value={selectedSchoolName || "School not available"} disabled className="bg-gray-100" />
//                         ) : (
//                           <>
//                             <Select value={form.schoolId} onValueChange={(value) => updateField("schoolId", value)}>
//                               <SelectTrigger
//                                 className={cn(errors.schoolId ? "border-red-500" : "")}
//                                 disabled={isFormLoading || isSchoolsLoading || !schools.length}
//                               >
//                                 <SelectValue placeholder={isSchoolsLoading ? "Loading schools..." : "Select school"} />
//                               </SelectTrigger>
//                               <SelectContent>
//                                 {schools.map((school) => (
...
//                               </SelectContent>
//                             </Select>
//                             {!schools.length && !isSchoolsLoading && (
//                               <p className="text-xs text-amber-600">No schools available. Please create a school before adding nurses.</p>
//                             )}
//                           </>
//                         )}
