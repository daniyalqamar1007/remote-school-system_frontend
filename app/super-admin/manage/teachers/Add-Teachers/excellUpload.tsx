...
export function TeachersExcelUploadModal({ open, onOpenChange, onClose, refetch, schoolId, onImportComplete }: ExcelUploadModalProps) {
          ...
          <div className="grid gap-6 py-4">
            ...
            <div className="flex justify-end">
              <Button
                ...
                disabled={!file || isUploading || !schoolId}
