...
export default function CourseAssignmentModal({
  ...
  const fetchAssigned = async () => {
    try {
      ...
      console.log('Raw assignments array:', JSON.stringify(assignments, null, 2))
      ...
      if (Array.isArray(assignments) && assignments.length > 0) {
        ...
        for (const a of assignments) {
          if (a?.courseId || a?.course?._id) {
            ...
            console.log(`Processing assignment for courseId: ${courseId}`, JSON.stringify(a, null, 2))
            
            if (Array.isArray(a.grades)) {
              console.log(`Grades array for course ${courseId}:`, JSON.stringify(a.grades, null, 2))
