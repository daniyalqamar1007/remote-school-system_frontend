...
const ClubReportsPage = () => {
  ...
  const handleExportReport = async (type: 'activity' | 'membership' | 'performance') => {
    ...
    try {
      ...
      const response = await fetch(`${process.env.NEXT_PUBLIC_SRS_SERVER}/admin/clubs/reports/${type}?schoolId=${selectedSchoolId}`, {
        headers: {
          'Authorization': `Bearer ${token}`
        }
      });
      ...
      <Card>
        <CardContent className="pt-6">
          <div className="space-y-2">
            ...
            {!selectedSchoolId && <p className="text-sm text-red-600">Please select a school to generate reports</p>}
          </div>
        </CardContent>
      </Card>
        ...
        <Card>
          ...
          <CardContent>
            <Button 
              ...
              disabled={!selectedSchoolId || isGenerating !== null}
            >
