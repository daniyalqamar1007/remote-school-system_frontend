  ...
  const fetchScheduleDetails = async () => {
    try {
      ...
      if (!scheduleData) {
        ...
        router.push('/teacher/sports/schedule');
        return;
      }
  ...
  return (
    <div className="container mx-auto px-4 py-6 space-y-6">
      ...
      <div className="flex items-center gap-4">
        <Link href="/teacher/sports/schedule">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <p className="font-medium">{formatTime(schedule.startTime || schedule.time)}</p>
              </div>
              <div>
                <Label className="text-muted-foreground flex items-center gap-2">
                  <Clock className="h-4 w-4" />
                ...
                <p className="font-medium">{formatTime(schedule.endTime || schedule.startTime || schedule.time)}</p>
              </div>
            </div>
            <div>
              <Label className="text-muted-foreground flex items-center gap-2">
      ...
      <div className="flex gap-2 justify-end">
        <Link href={`/teacher/sports/schedule/${scheduleId}/edit`}>
          <Button variant="outline">
            Edit Event
          </Button>
        </Link>
